...
try {
  ...
  alert(error);
    ...
    alert('Please ekteb 7aja bech tjik 7aja');
  }
...
const handleSurpriseMe = () => {
  ...
  return (
   <section className='max-w-7xl mx-auto'>
    <div>
        <h1 className='font-extrabold text-[#222928]
      text-[32px]'>
          Create
        </h1>
        <p className='mt-2 text-[#666e75] text-[14px] max-w-[500px]'>Ekteb Elli t7eb yjik Elli t7eb by Dhia Mahdaoui</p>
      </div>
      <form className='mt-16 max-w-3xl' onSubmit={handleSubmit}>
        ...
        <div className='mt-10'>
          ...
          text-[14px]'>Once you have created the image if you want you 
            can share it with others in the community</p>
            <button
              type='submit' 
              className='mt-2 text-white bg-[#6464ff]
